            ...
            hover:scale-105 ${ifExists ? 'justify-items-start':'justify-items-center'}`}>
                ...
                `}>
                    ...
                    <div className='flex items-center justify-between w-28 my-2'>
                        <div className='flex items-center text-white/80 px-1 rounded blur-effect-theme  '>
                    ...
                    <div className='flex items-center gap-3'>
                        <button type='button' className=' blur-effect-theme 
                        ...
                        <button type='button' onClick={() => {onAddToCart(); onCartToggle() }}
                         className='text-white/90 blur-effect-theme py-1 
