...
const FlexContent: React.FC<IHiglight> = ({
  ifExists,
  title,
  heading,
  img,
  ...
  return (
    <>
      <div
        className={`flex items-center justify-between lg:flex-col
        lg:justify-center nike-container ${
          !ifExists ? "flex-row" : "flex-row-reverse"
        }`}
      >
        <div
          className="max-w-lg lg:max-w-none w-full md:text-center grid items-center
        ...
        >
          ...
          <h1
            className="text-5xl lg:text-4xl md:text-3xl
          ...
          >
            <button
              type="button"
              className="button-theme shadow-white
                    text-slate-100 py-1.5"
            >
              {btn}
            </button>
          </a>
            ...
            className={`w-auto object-fill transitions-theme
                    ${
                      ifExists
                        ...
                        : "h-72 lg:h-64 md:h-60 sm:h-48 rotate-[19deg] hover:rotate-12"
                    }`}
          />
        </div>
      </div>
