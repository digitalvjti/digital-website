        ...
        <div className={`blur-effect-theme h-screen max-w-xl w-full absolute right-0`}>
          ...
          {cartItems.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> : <div>
              ...
              {cartItems?.map((item:any, i:number) => (
                ...
                <div className='fixed bottom-0 w-full px-6 py-2 grid items-center'>
                  ...
                  <div className='grid items-center gap-2'>
                    <p className='text-sm font-medium text-center'>Impostos e envio serão calculados no envio</p>
                    <button type='button' className='button-theme bg-theme-cart text-white'>Confira</button>
                  </div>
                </div>
